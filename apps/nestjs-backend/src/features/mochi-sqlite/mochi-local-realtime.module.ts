...
import { MochiLocalWorkspaceWatchService } from './mochi-local-workspace-watch.service';
...
@Module({
  ...
  providers: [
    MochiLocalShareDbService,
    MochiLocalWsGateway,
    MochiLocalActionTriggerListener,
    MochiLocalWorkspaceWatchService,
  ],
